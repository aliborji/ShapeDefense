...
def main():
    ...
    model = define_model(args.net_type)# PreActResNet18(args.net_type)#()    
    model.train()
    ...
    model_test = define_model(args.net_type)()# PreActResNet18(args.net_type)#()    
    model_test.load_state_dict(model.state_dict())
    model_test.float()
    model_test.eval()

    pgd_loss, pgd_acc = evaluate_pgd(test_loader, model_test, 5, 10)
