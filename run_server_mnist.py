...
fo = open(f'./{attack_type}/results/results_{net_type}.txt', 'w+')
...
for eps_t in [8,32,64]:
    ...
    save_path_robust = f'./{attack_type}/mnist_{net_type}_{eps_t}_robust_{eps_t}.pth'
    ...
    save_path_robust = f'./{attack_type}/mnist_{net_type}_{eps_t}_robust_{eps_t}_redetect.pth'
